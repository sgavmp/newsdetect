/* QueryConstructorTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. QueryConstructorTokenManager.java */
package com.ikip.newsdetect.topic.queryconstructor;

/** Token Manager. */
@SuppressWarnings("unused")public class QueryConstructorTokenManager implements QueryConstructorConstants {
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public QueryConstructorTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public QueryConstructorTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
