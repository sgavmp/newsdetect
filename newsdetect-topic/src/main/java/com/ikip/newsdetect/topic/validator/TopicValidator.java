...
import com.ikip.newsdetect.topic.util.QueryUtil;
...
public class TopicValidator implements TopicValidatorConstants {
  ...
  final public void topic3() throws ParseException {Token tk;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case TERM:{
...
sem.validateReferenceToTopic(QueryUtil.internize(tk.image));
  ...
  public TopicValidator(java.io.InputStream stream, String encoding) {
